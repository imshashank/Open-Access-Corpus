	<!--Start Content-->
		<div id="content" class="col-xs-12 col-sm-10">
			<?php
include('/var/www/html/oac-web//article_class.php');
include('/var/www/html/oac-web/includes/db.php');
			...
			<div id="ow-marketplace" class="col-sm-12 col-md-6">
				...
				<table id="ticker-table" class="table m-table table-bordered table-hover table-heading">
					...
					<tbody>
						...
						<tr><td>H. Kim</td><td>1583</td></tr><tr><td>J. Zhang</td><td>1360</td></tr><tr><td>Y. Liu</td><td>1318</td></tr><tr><td>L. Zhang</td><td>1094</td></tr><tr><td>J. Smith</td><td>1044</td></tr><tr><td>Y. Chen</td><td>1034</td></tr><tr><td>D. Strom</td><td>1028</td></tr><tr><td>M. Weber</td><td>1013</td></tr><tr><td>Z. Zhang</td><td>962</td></tr><tr><td>J. Wang</td><td>918</td></tr>					
				...
				<div id="ow-summary" class="row">
					<div class="col-xs-12">
						...
						<div class="row">
							<div class="col-xs-12">
								<div class="row">
									<div class="col-xs-6">Total Articles<b><?php echo '2020935'; #$obj->total_articles(); ?></b></div>
									<div class="col-xs-6">Total Authors<b><?php echo '2786115'; #$obj->total_authors(); ?></b></div>
								</div>
								<div class="row">
									<div class="col-xs-6">Total Journals<b><?php echo '11854'; #$obj->total_journals(); ?></b></div>
									<div class="col-xs-6">Total Publishers<b><?php echo '4265'; #$obj->total_publishers(); ?></b></div>
								</div>
								<div class="row">
									<div class="col-xs-6">Total Tags <b><?php echo '914554';#$obj->total_tags(); ?></b></div>
									<div class="col-xs-6">Total DOI<b><?php echo '1124165'; #$obj->total_dois(); ?></b></div>
								</div>
							</div>
						</div>
					</div>
