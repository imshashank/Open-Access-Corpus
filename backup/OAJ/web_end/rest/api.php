<?php
 ...
 #remove the directory path we don't want
  $request  = str_replace("/rest/", "", $_SERVER['REQUEST_URI']);
  #split the path by '/'
  $this->params     = split("/", $request);
$func = $params['0'];
#  var_dump($this->params);
$func = strtolower(trim(str_replace("/","",$this->params['0'])));
$this->params['0'] = mysql_real_escape_string($this->params['0']);
$this->params['1'] = mysql_real_escape_string($this->params['1']);
